...
repair=Path('supabase/migrations/20260805105743_restore_exact_owner_three_network_authority_after_104812_stale_cycle.sql').read_text()
...
ck(on['authoritative_migration']['version']=='20260805105743','repair migration')
...
ck(op['onchain_authoritative_migration_version']=='20260805105743' and op['onchain_settlement_asset']=='pending','release authority')
