...
export default defineConfig({
  testDir: './tests',
  testMatch: /v79-(?:mobile-smoke|intelligence-home-smoke|news-shell-smoke|news-filter-cycle-smoke|admin-recovery-smoke|admin-session-smoke|public-user-e2e|email-access-smoke|backtest-v15-ui-smoke|follower-access-smoke)\.spec\.js/,
  timeout: 45_000,
