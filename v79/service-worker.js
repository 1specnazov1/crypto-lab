...
// Legacy contract marker only: crypto-lab-v79-7930-pwa2. Active cache remains pwa3.
const SHELL=['./','./index.html','./app.html','./app.css','./app.js','./app-extension.js','./support-extension.js','./commercial-extension.js','./accessibility.js','./module-accessibility.js','./platform.css','./module-mobile.css','./manifest.webmanifest','./icon.svg','./offline.html','./chart.html','./portfolio.html','./calculator.html','./backtest.html','./backtest-history.js','./scanner.html','./scanner-actions.js','./ai.html','./journal.html','./journal.js','./journal-import.js','./journal-analytics.js','./account.html','./account-actions.js','./session-security.js','./friends-family-account.js','./registration-consent.js','./auth-gateway.js','./support.html','./admin.html','./admin-health.js','./admin-incidents.js','./admin-slo.js','./admin-ops-summary.js','./admin-integrity.js','./admin-drift.js','./admin-maintenance.js','./admin-deletions.js','./admin-support.js','./admin-commercial.js','./admin-billing-events.js','./admin-friends-family.js','./admin-provider-readiness.js','./admin-audit.js','./admin-session-security.js','./admin-readiness.js','./admin-telemetry.js','./admin-ai-telemetry.js','./legal.js','./privacy.html','./terms.html','./risk-disclosure.html','./refund.html'];
const AUTH_NETWORK_FIRST=new Set(['account.html','account-actions.js','registration-consent.js','app-extension.js','commercial-extension.js','friends-family-account.js','admin-friends-family.js','chart.html','scanner.html','ai.html','backtest.html']);
