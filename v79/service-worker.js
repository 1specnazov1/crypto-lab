'use strict';
const CACHE='crypto-lab-v79-7930-auth1';
const SHELL=['./','./index.html','./app.html','./app.css','./app.js','./app-extension.js','./support-extension.js','./commercial-extension.js','./accessibility.js','./module-accessibility.js','./platform.css','./module-mobile.css','./manifest.webmanifest','./icon.svg','./offline.html','./chart.html','./portfolio.html','./calculator.html','./backtest.html','./backtest-history.js','./scanner.html','./scanner-actions.js','./ai.html','./journal.html','./journal.js','./journal-import.js','./journal-analytics.js','./account.html','./account-actions.js','./session-security.js','./registration-consent.js','./auth-gateway.js','./commercial.js','./subscription-lifecycle.js','./support.html','./admin.html','./admin-health.js','./admin-incidents.js','./admin-slo.js','./admin-ops-summary.js','./admin-integrity.js','./admin-drift.js','./admin-maintenance.js','./admin-deletions.js','./admin-support.js','./admin-commercial.js','./admin-billing-events.js','./admin-provider-readiness.js','./admin-audit.js','./admin-session-security.js','./admin-readiness.js','./admin-telemetry.js','./admin-ai-telemetry.js','./legal.js','./privacy.html','./terms.html','./risk-disclosure.html'];
