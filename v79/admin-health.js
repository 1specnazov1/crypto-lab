...
(() => {
  ...
  function render(data){
    const scanner=data?.scanner||{},monitor=data?.monitor||{},stale=data?.stale_runs||{},maintenance=data?.last_maintenance||{},billing=data?.billing||{},jobs=Array.isArray(data?.cron_jobs)?data.cron_jobs:[],deletions=Array.isArray(data?.pending_deletions)?data.pending_deletions:[];
