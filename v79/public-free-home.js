...
(() => {
  ...
  }catch(error){console.warn('FREE status patch unavailable',error);}

  const applyStatic=()=>{
    const ver=document.querySelector('.head .ver');if(ver)ver.textContent='v79 · FREE';
