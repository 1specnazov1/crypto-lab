...
comment on function public.run_crypto_maintenance() is
  'Runs bounded CRYPTO LAB retention and stale-run cleanup. Uses wall-clock timestamps for measurable duration and preserves maintenance runs referenced by immutable evidence seals.';
