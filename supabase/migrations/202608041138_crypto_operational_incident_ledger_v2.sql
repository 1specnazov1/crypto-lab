...
do $$
begin
  if exists(select 1 from cron.job where jobname='crypto-signal-monitor-every-minute') then
  ...
  if exists(select 1 from cron.job where jobname='crypto-market-scanner-every-15-minutes') then
