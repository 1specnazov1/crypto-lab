...
set authority_state='superseded',
    evidence=evidence||jsonb_build_object(
      'invalidated_by_migration','authoritative_candidate_only_recovery_after_100805',
...
set desired_mode='disabled',lifecycle_status='draft',checkout_enabled=false,webhook_enabled=false,
    ...
    last_verification=jsonb_build_object(
      ...
      'false_100805_authority_superseded',true
    ),updated_at=now()
...
set status='decision_required',
    ...
    evidence=jsonb_build_object(
      ...
      'owner_approval_recorded',false,'false_100805_authority_superseded',true,
...
set status='blocked_dependency',decision_summary='{}'::jsonb,
    evidence=jsonb_build_object(
      ...
      'false_100805_authority_superseded',true,'overlapping_automation_disabled',true
    ),
